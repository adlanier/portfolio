...
const Education = () => (
  <div>
    ...
    <p class="coursework">
    Calculus of Functions of Several Variables (MATH 233) -  Vector algebra, solid analytic geometry, partial derivatives, multiple integrals.
    </p> */}
    {/* <p class="coursework">
