...
const Experience = () => (
  <div>
    ...
    <p>As a Software Engineering Intern at Pearson, I migrated a legacy Salesforce application 
      ...
      and iterate on tailored solutions. At the conclusion of my internship, I presented the technical and business outcomes of the project to company leadership, highlighting increased revenue potential, improved usability, and more efficient workflows.

    </p>
    <h3>Undergraduate Teaching Assistant</h3>
      <p><i>UNC Department of Computer Science</i></p>
      <p>August 2023 - January 2025</p> <p>
        As an Undergraduate Teaching Assistant, I have had the unique opportunity to work with students in both UNC's COMP 110: Intro to Programming course and COMP 210: Data Structures and Analysis.
